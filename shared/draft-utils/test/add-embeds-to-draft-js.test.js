...
describe('sites', () => {
  ...
  describe('thread urls', () => {
    it('should handle full thread urls', () => {
      const text =
        'http://spectrum.gq/spectrum/general/hello~4026b1bd-3896-46a4-9ade-e621a90e64ad';
      expect(getEmbedsFromText(text)).toEqual([
        {
    ...
    it('should handle /thread/:id urls', () => {
      const text =
        'http://spectrum.gq/thread/4026b1bd-3896-46a4-9ade-e621a90e64ad';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
    ...
    it('should handle ?thread urls with query params before', () => {
      const text =
        'http://spectrum.gq/?m=asdf&thread=4026b1bd-3896-46a4-9ade-e621a90e64ad';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
    ...
    it('should handle ?thread urls with query params after', () => {
      const text =
        'http://spectrum.gq/?thread=4026b1bd-3896-46a4-9ade-e621a90e64ad&m=asdf';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
    ...
    it('should handle ?t urls', () => {
      const text = 'http://spectrum.gq/?t=4026b1bd-3896-46a4-9ade-e621a90e64ad';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
    ...
    it('should handle ?t urls with query params before', () => {
      const text =
        'http://spectrum.gq/?m=asdf&t=4026b1bd-3896-46a4-9ade-e621a90e64ad';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
    ...
    it('should handle ?t urls with query params after', () => {
      const text =
        'http://spectrum.gq/?t=4026b1bd-3896-46a4-9ade-e621a90e64ad&m=asdf';
      expect(getEmbedsFromText(text)).toEqual([
        {
          id: '4026b1bd-3896-46a4-9ade-e621a90e64ad',
          entity: 'thread',
