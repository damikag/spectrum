        ...
        attachments: [
          {
            ...
            author_link: `http://spectrum.gq/users/${author.username}`,
            ...
            title_link: `http://spectrum.gq/thread/${incomingThread.id}`,
            text: truncateString(plainTextBody, 140),
            footer: 'Spectrum',
            footer_icon:
              'http://spectrum.gq/img/apple-icon-57x57-precomposed.png',
            ...
            actions: [
              {
                ...
                url: `http://spectrum.gq/thread/${incomingThread.id}`,
              },
              {
                type: 'button',
                text: `Message ${author.name}`,
                url: `http://spectrum.gq/users/${author.username}`,
              },
            ],
          },
        ],
