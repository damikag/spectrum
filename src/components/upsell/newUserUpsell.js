    ...
    return (
      <NullCard bg="onboarding" repeat={true} noPadding>
        ...
        <Section>
          ...
          <ButtonRow>
            <a
              href={`https://www.facebook.com/sharer/sharer.php?u=http://spectrum.gq&t=Come hang out with me on Spectrum, a new place on the internet for communities!`}
              target="_blank"
            ...
            <a
              href={`https://twitter.com/share?text=Come hang out with me on @withspectrum, a new place on the internet for communities!&url=http://spectrum.gq`}
              target="_blank"
              rel="noopener noreferrer"
            >
