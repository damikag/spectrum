...
const communityBeforeUrlIsValid = () =>
  cy.url().should('eq', 'http://spectrum.gq/spectrum?tab=posts');
const channelBeforeUrlIsValid = () =>
  cy.url().should('eq', 'http://spectrum.gq/spectrum/general?tab=posts');
...
describe.skip('thread modal route', () => {
  ...
  it('handles esc key', () => {
    ...
    cy.url(
      'eq',
      'http://spectrum.gq/spectrum/private/yet-another-thread~thread-6'
    );
  ...
  it('handles channel feed', () => {
    ...
    cy.url(
      'eq',
      'http://spectrum.gq/spectrum/spectrum/general/yet-another-thread~thread-9'
    );
