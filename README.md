<div align="center">
  ...
  [![Spectrum](./public/img/media.png)](http://spectrum.gq)

  ### Simple, powerful online communities.

</div>

This is the main monorepo codebase of [Spectrum](http://spectrum.gq). Every single line of code that's not packaged into a reusable library is in this repository.
...
Spectrum has been in full-time development since March 2017 and is [part of GitHub since November 2018](http://spectrum.gq/spectrum/general/spectrum-is-joining-github~1d3eb8ee-4c99-46c0-8daf-ca35a96be6ce). See our current priorities and what we are working on in the [main project board](https://github.com/withspectrum/spectrum/projects/23).
